% AddTextToImageDemo is a script to demonstrate what AddTextToImage does.
...
axis off image;
for i = 1:Iterations
    Image = AddTextToImage(Image,Strings{StringIndices(i)},[XPositions(i) YPositions(i)],Colors(i,:),Fonts{FontIndices(i)});
